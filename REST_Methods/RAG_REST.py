...
# LLM_JWT_BEARER = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyMjkxNDgxLTU4NDItNDlkNi1iMjhkLTFmZDZjZWYwYjkzMiJ9.hOf578efg-7uV0sQCKVb_WIU9t5DKVoyspoU3vYV_yI"
...
def response(data, llm, parser, context):
    ...
    data.to_excel("response_REST_RAG_CodeStral3.xlsx", index=False)  
